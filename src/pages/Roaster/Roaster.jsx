    ...
    <div className="Roaster__mainContainer">
      ...
      <div className="Roaster__content">
        ...
        <div className="Roaster__body">
          <div className="Roaster__mainontent">
            <div className="Roaster__titleButton">
              <span className="Roaster__title__roaster__button__div">
                {" "}
                <h4 className="Roaster__creationTitle">
                  Create an Employee Roster
                </h4>
                <button className="Roaster__Button" onClick={() =>{
                  navigate("/open-roaster")
                }}>See Roaster</button>
              </span>
            </div>
            <form className="Roaster__form" onSubmit={handleSubmit}>
